...
def get_resource_prompt(
    ...
    Args:
        resource_key: The content file key (e.g. "explanation.md").
    ...
    source_context = ""
    if source_summary:
        source_context = f"Ground your response and data from the following source materials, DO NOT MAKE ANY ASSUMPTIONS:\n{source_summary}"
